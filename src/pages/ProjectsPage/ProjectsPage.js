...
import { Bird } from './components/SvgElements';
import { generateBirds, generateClouds, SIZE_TO_CLASS, OPACITY_TO_CLASS, SPEED_TO_CLASS } from './utils/generators';
      ...
      <div className={`${styles.projectsPage}`} ref={pageRef}>
        ...
        <div className={styles.backgroundClouds}>
          {decorativeClouds.map((cloud) => (
            <img
              key={cloud.id}
              src={`${import.meta.env.BASE_URL}/images/${cloud.image}`}
              alt=""
